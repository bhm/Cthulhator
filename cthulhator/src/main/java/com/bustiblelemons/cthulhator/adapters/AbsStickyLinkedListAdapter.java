...
import com.bustiblelemons.adapters.AbsLinkedListAdapter;
 ...
 */
public abstract class AbsStickyLinkedListAdapter<T, H extends ViewHolder<T>, SH extends ViewHolder<T>>
        extends AbsLinkedListAdapter<T, H>
        implements StickyListHeadersAdapter {

    public AbsStickyLinkedListAdapter(Context context) {
        super(context);
    }

    public AbsStickyLinkedListAdapter(Context context, List<T> data) {
        super(context, data);
    }
